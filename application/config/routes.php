...
//statics
$route['user/send-again'] = "user/sendAgain";
$route['user/forgot-password'] = "user/forgotPassword";
$route['user/reset-password'] = "user/resetPassword";
$route['user/change-password'] = "user/changePassword";
$route['user/change-email'] = "user/changeEmail";
$route['user/reset-email'] = "user/resetEmail";
